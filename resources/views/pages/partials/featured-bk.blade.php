                ...
                @foreach($products as $product)                   
                    ...
                    <div class="col-sm-6 col-md-3 animated zoomIn" id="featured-container">
                        ...
                        @else
                            @if ($product->featuredPhoto)
                                <img src="{{ $product->thumbnail_path }}" alt="Photo ID: {{ $product->featuredPhoto->id }}" />
                    ...
                    <div class="col-sm-6 col-md-3 animated zoomIn" id="featured-container-m">
                        <a href="{{ route('show.product', $product->product_name) }}">
                            ...
                            <div class="col-xs-6">
                                @if ($product->photos->count() === 0)
                                    <img src="/store/src/public/images/no-image-found.jpg" alt="No Image Found Tag" style="width: 200px; height: 200px;" id="image-m">
                                @else
                                    @if ($product->featuredPhoto)
